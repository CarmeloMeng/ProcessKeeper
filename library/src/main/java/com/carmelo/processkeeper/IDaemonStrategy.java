package com.carmelo.processkeeper;

import android.content.Context;
import android.os.Build;

import com.carmelo.processkeeper.strategy.DaemonStrategy21;
import com.carmelo.processkeeper.strategy.DaemonStrategy22;
import com.carmelo.processkeeper.strategy.DaemonStrategy23;
import com.carmelo.processkeeper.strategy.DaemonStrategyUnder21;
import com.carmelo.processkeeper.strategy.DaemonStrategyXiaomi;
            ...
            switch (sdk) {
                ...
                default:
                    if (Build.MODEL != null && Build.MODEL.toLowerCase().startsWith("mi")
                            && !Build.MODEL.toLowerCase().startsWith("mi note")) {
